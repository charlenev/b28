defineSuite([
         'Scene/WebCoverageServiceImageryProvider_v2',
         'Core/defined',
         'Core/jsonp',
         'Core/loadImage',
         'Core/DefaultProxy',
	...
	it('requires name of the coverage (coverageid)', function(){
		var description = {
				url : 'made/up'
		};
   ...
   it('requestImage returns a promise for an image and loads it for cross-origin use', function() {
        ...
        expect(provider.coverageid).toEqual('id');
	...
	it('contains a parameter to subsetting the coverage', function(){
		var description = {
			url : 'made/up',
			coverageid : 'id',
			parameters : {
        ...
        runs(function() {
            var calledLoadImage = false;
            loadImage.createImage = function(url, crossOrigin, deferred) {
				expect(url).toMatch('subset');
				expect(description.parameters.subset).toEqual('imageCRS');
                calledLoadImage = true;
                deferred.resolve();
                return undefined;
            };
